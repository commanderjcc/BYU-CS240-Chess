...
public class CMove implements chess.ChessMove{
    ...
    /**
     * Converts the CMove object to a string.
     *
     * @return string representation of the CMove object
     */
    @Override
    public String toString() {
        String letter1 = String.valueOf((char) (start.getColumn() + 96));
        String number1 = String.valueOf(start.getRow());
        String letter2 = String.valueOf((char) (end.getColumn() + 96));
        String number2 = String.valueOf(end.getRow());
